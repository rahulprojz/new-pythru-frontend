...
const SalesOrder = (props: EstimateMenuProps) => {
  ...
  const convertIntoBill = () => {
    navigate("/sales/delivery/add/" + detail._id, labelsDeliveryChallan);
  };

  const handleEmailSubmit = (email: string) => {
    dispatch(sendDoument(detail._id, email));
  ...
  return (
    <div>
        ...
        <div className="Dflex al-cnt sp-bt m-b-10 wrap">
          ...
          >
            ...
            {/* {[statusEnum.NOT_SENT, statusEnum.PENDING].includes(
                ...
                <>
                  <MenuItem onClick={resendSalesOrder} disableRipple>
                    Resend Sales order
                  </MenuItem>
                </>
              ) : (
            ...
            {[statusEnum.NOT_SENT, statusEnum.PENDING].includes(
              ...
              <>
                <MenuItem onClick={sendSalesOrder} disableRipple>
                  Send Sales order
                </MenuItem>
              </>
            ) : (
            ...
            {[statusEnum.NOT_SENT, statusEnum.PENDING].includes(
              ...
              <MenuItem onClick={convertIntoBill} disableRipple>
      ...
      <DeleteDialogs
        ...
        popimg={deleteIMG}
        dialogTitle={`Cancel sales order`}
        yesHandle={() => {
        ...
        dialogPara="Are you sure you want to cancel this sales order?"
        nvCancel="Cancel"
        nvYes="Yes"
      />
      <SalesOrderEmail
