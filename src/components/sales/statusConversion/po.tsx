...
const PO = (props: EstimateMenuProps) => {
  ...
  return (
    <div>
      <div className="invoice-detail-card m-b-20">
        <div className="Dflex al-cnt sp-bt m-b-10 wrap">
          ...
          >
            ...
            {[statusEnum.PENDING, statusEnum.CLOSED].includes(detail.status) ? (
              <MenuItem onClick={resendPurchaseOrder} disableRipple>
      ...
      <DeleteDialogs
        ...
        popimg={deleteIMG}
        dialogTitle={`Cancel purchase order`}
        yesHandle={() => {
        ...
        dialogPara="Are you sure you want to cancel this purchase order?"
        nvCancel="Cancel"
        nvYes="Yes"
      />
    </div>
