...
export default function EnhancedTable(props: TableTpProps) {
  ...
  const { setState, filterPress, labels, handleAddDebitNote } = props;
                        ...
                        <div className={"iconsContainer"}>
                          <a
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              navigate(
                                `/purchase/debit-note/edit/${row._id}`,
                                labels
                              );
                            }}
                            className={
                          ...
                          {/* <MenuBar
                            ...
                            pageEdit={true}
                            redirectLink={"/purchase/debit-note/edit"}
                            data={labels}
                            isEdit={
