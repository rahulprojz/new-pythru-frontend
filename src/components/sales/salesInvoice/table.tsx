...
export default function EnhancedTable(props: TableTpProps) {
  ...
  const { setState, filterPress, labels, handleAddInvoice } = props;
                    ...
                    >
                      ...
                      <TableCell>
                        <a
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            navigate(`${pathname}/edit/${row._id}`, labels);
                          }}
                          className={
                            !((permissions && pathname.includes("payment")
                              ? permissions && permissions["payments"].edit
