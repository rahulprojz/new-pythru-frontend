  ...
  return (
    <div>
      <div className="invoice-detail-card m-b-20">
        <div className="Dflex al-cnt sp-bt m-b-10 wrap">
          ...
          >
            ...
            {[statusEnum.PENDING].includes(detail.status) ? (
              <MenuItem onClick={resendPurchaseOrder} disableRipple>
                Resend Receipt note
              </MenuItem>
            ) : (
      ...
      <DeleteDialogs
        ...
        popimg={deleteIMG}
        dialogTitle={`Cancel receipt note`}
        yesHandle={() => {
        ...
        dialogPara="Are you sure you want to cancel this receipt note?"
        nvCancel="Cancel"
        nvYes="Yes"
      />
    </div>
