...
export default function EnhancedTable(props: TableTpProps) {
  ...
  const { setState, filterPress, labels, handleAddPurchaseOrder } = props;
                        ...
                        <div className={"iconsContainer"}>
                          <a
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              navigate(
                                `/purchase/purchase-order/edit/${row._id}`,
                                labels
                              );
                            }}
                            className={
                          ...
                          {/* <MenuBar
                            ...
                            pageEdit={true}
                            redirectLink={"/purchase/purchase-order/edit"}
                            data={labels}
                            isEdit={
