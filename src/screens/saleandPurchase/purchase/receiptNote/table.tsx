...
export default function EnhancedTable(props: TableTpProps) {
  ...
  const { setState, filterPress, labels, handleAddReceiptNote } = props;
                      ...
                      <TableCell>
                        <div className={"iconsContainer"}>
                          {/* <MenuBar
                            ...
                            pageEdit={true}
                            redirectLink={"/purchase/receipt-note/edit"}
                            data={labels}
                            isEdit={
                          ...
                          <a
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              navigate(
                                `/purchase/receipt-note/edit/${row._id}`,
                                labels
                              );
                            }}
                            className={
